...
<body>
    ...
    <div id="welcome-modal" class="welcome-modal">
        <div class="welcome-content">
            ...
            <div class="welcome-text">
                <strong>📍 Star Chart View:</strong> View all goals as a static star chart with galaxy regions subtly shaded. Search for any player and use the filter panel to customize which goals to include, then draw their constellation connecting related goal clusters. Perfect for analyzing specific players or creating custom star patterns.
            </div>
            <div class="welcome-text">
